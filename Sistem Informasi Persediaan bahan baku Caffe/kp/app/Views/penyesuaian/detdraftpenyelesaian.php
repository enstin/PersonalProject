            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <label>Jumlah</label>
                            <input type="text" name="jumlah" id="jumlah" class="form-control" placeholder="0" value="0" required>
                        </div>
                        <div class="form-group">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="<?= $link; ?>/transaksi-detpenyesuaian/hapusitem/<?= $dump['id_penyesuaian']; ?>" class="btn btn-primary">Ya</a>
