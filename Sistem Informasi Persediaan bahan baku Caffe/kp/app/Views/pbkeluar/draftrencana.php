        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Draft Perencanaan Keluar</h3>
                        </div>
                        <!-- /.card-header -->
                                    ...
                                    <?php foreach ($data_dump as $dump) : ?>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="" class="btn btn-primary" data-toggle="modal" data-target="#edit<?= $dump['id_detpbkeluar']; ?>">Edit</a>
                                            </td>
                                        </tr>
                                        <!-- model hapus -->
                                        ...
                                        <!-- end of model hapus -->
                                        <!-- model edit -->
                                        <div class="modal fade" id="edit<?= $dump['id_detpbkeluar']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="card-header">
                                                    ...
                                                    <form action="<?= $link; ?>/ubah-draftrencana/<?= $dump['id_detpbkeluar']; ?>" method="POST">
                                                        <div class="modal-body">
                                                            <!-- general form elements -->
                                                            <div class="card-body">
                                                                <div class="form-group">
                                                                    <label for="exampleInputEmail1">ID barang</label>
                                                                    <input type="text" class="form-control" name="idbrg" readonly value="<?= $dump['id_barang']; ?>" required>
                                                                </div>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" id="jml" name="jumlah" value="<?= $dump['jumlah']; ?>" required>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer">
