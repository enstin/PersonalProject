...
class modreturminta_g2 extends Model
{
   ...
   public function tampildump()
   {
      return $this->db->table('dump_detretminta')
         ...
         ->join('barang_c2', 'barang_c2.id_barang=detpermintaan.id_barang')
         ->join('ukuran', 'barang_c2.id_ukuran=ukuran.id_ukuran')
         ->join('cr', 'barang_c2.id_cr=cr.id_cr')
   ...
   {
      return $this->db->table('barang_c2')
         ->update($data, $id);
   }
