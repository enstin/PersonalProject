...
class modpermintaan extends Model
{
    ...
    public function tampilpermintaan_nonacc_tambah()
    {
        return $this->db->table($this->permintaan)
            ...
            ->orwhere('status', 'akan dikirim-g2')
            ->orwhere('status', 'akan dikirim-g3')
            ->orwhere('status', 'dikirim-g3')
            ->orwhere('status', 'dikirim-g2')
            // ->where('status', 'disetujui-g2')
            // ->orwhere('status', 'disetujui-g3')
            // ->orwhere('status', 'belum disetujui-g1')
            // ->orwhere('status', 'disetujui-g1')
            ->get()->getResultArray();
    }
    ...
    public function optionsatuan($id)
    {
    ...
    public function optionsatuanwheregudang($id)
    {
        return $this->db->table('detbarang')
            ->select('*')
            ->join('cr', 'detbarang.id_cr=cr.id_cr')
    ...
    public function permintaanwhere($id)
    {
    ...
    public function lihatpermintaan($id)
    {
        return $this->db->table('detpermintaan')
            ->select('*')
            ->join('permintaan', 'permintaan.id_permintaan=detpermintaan.id_permintaan')
    ...
    public function optionsatuan_g2()
    {
        return $this->db->table('detbarang')
            ->select('*')
            ->join('barang', 'detbarang.id_barang=barang.id_barang')
    ...
    public function optionsatuan_g3()
    {
        return $this->db->table('detbarang')
            ->select('*')
            ->join('barang', 'detbarang.id_barang=barang.id_barang')
