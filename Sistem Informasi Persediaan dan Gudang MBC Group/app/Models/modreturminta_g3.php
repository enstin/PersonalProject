...
class modreturminta_g3 extends Model
{
   ...
   public function tampildump()
   {
      return $this->db->table('dump_detretminta')
         ...
         ->join('barang_c3', 'barang_c3.id_barang=detpermintaan.id_barang')
         ->join('ukuran', 'barang_c3.id_ukuran=ukuran.id_ukuran')
         ->join('cr', 'barang_c3.id_cr=cr.id_cr')
   ...
   {
      return $this->db->table('barang_c3')
         ->update($data, $id);
   }
