...
<div class="content-wrapper">
    ...
    <?php if (session()->get('gudang') == 'g1') : ?>
        <!-- SELECT2 EXAMPLE -->
        <form action="/permintaan/tambah_item" method="post">
    ...
    <?php elseif (session()->get('gudang') == 'g2') : ?>
        <!-- SELECT2 EXAMPLE -->
        <form action="/permintaan_g2/tambah_item" method="post">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">ITEM</h3>
                    <div class="card-tools">
    ...
    <?php elseif (session()->get('gudang') == 'g3') : ?>
        <!-- SELECT2 EXAMPLE -->
        <form action="/permintaan_g3/tambah_item" method="post">
            <div class="card card-default">
                <div class="card-header">
                    <h3 class="card-title">ITEM</h3>
                    <div class="card-tools">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <?php if (session()->get('gudang') == 'g1') : ?>
                            <a href="/permintaan/simpandraft" class="btn btn-success">SIMPAN</a>
                        <?php elseif (session()->get('gudang') == 'g2') : ?>
                            <a href="/permintaan_g2/simpandraft" class="btn btn-success">SIMPAN</a>
                        <?php elseif (session()->get('gudang') == 'g3') : ?>
                            <a href="/permintaan_g3/simpandraft" class="btn btn-success">SIMPAN</a>
                        <?php endif; ?>
                        <div class="card-body">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/permintaan/delete_item/<?= $pesan['id_detpermintaan']; ?>" class="btn btn-primary">Ya</a>
                                            ...
                                            <div class="modal fade" id="edit<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/permintaan/update_item/<?= $pesan['id_detpermintaan']; ?>" method="POST">
                                                            <div class="modal-body">
                                                                <!-- general form elements -->
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                            ...
                                            <div class="modal fade" id="hapus<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/permintaan_g2/go_tambah_permintaan/delete_item/<?= $pesan['id_detpermintaan']; ?>" class="btn btn-primary">Ya</a>
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal fade" id="edit<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/permintaan_g2/go_tambah_permintaan/update_item/<?= $pesan['id_detpermintaan']; ?>" method="POST">
                                                            <div class="modal-body">
                                                                <!-- general form elements -->
                                                                <div class="card-body">
                                                                    <div class="form-group">
                                            ...
                                            <div class="modal fade" id="hapus<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/permintaan_g3/go_tambah_permintaan/delete_item/<?= $pesan['id_detpermintaan']; ?>" class="btn btn-primary">Ya</a>
                                                            <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal fade" id="edit<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/permintaan_g3/go_tambah_permintaan/update_item/<?= $pesan['id_detpermintaan']; ?>" method="POST">
                                                            <div class="modal-body">
                                                                <!-- general form elements -->
                                                                <div class="card-body">
                                                                    <div class="form-group">
