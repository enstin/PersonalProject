                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <a href="/permintaan/go_tambah_permintaan/delete_item/<?= $pesan['id_detpermintaan']; ?>" class="btn btn-primary">Ya</a>
                                            ...
                                            <div class="modal fade" id="edit<?= $pesan['id_detpermintaan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="/permintaan/go_tambah_permintaan/update_item/<?= $pesan['id_detpermintaan']; ?>" method="POST">
                                                            <div class="modal-body">
                                                                <!-- general form elements -->
                                                                <div class="card-body">
