...
<div class="content-wrapper">
    ...
    <?php endif; ?>
    <!-- SELECT2 EXAMPLE -->
    <form action="/pemesanan/tambah_item_nonacc" method="post">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <a href="/pemesanan/simpandraft_nonacc" class="btn btn-success">SIMPAN</a>
                        <div class="card-body">
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="/pemesanan/non-acc_delete/<?= $pesan['id_detpesan']; ?>" class="btn btn-primary">Ya</a>
                                        ...
                                        <div class="modal fade" id="edit<?= $pesan['id_detpesan']; ?>" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="/pemesanan/non-acc_update/<?= $pesan['id_detpesan']; ?>" method="POST">
                                                        <div class="modal-body">
                                                            <!-- general form elements -->
                                                            <div class="card-body">
                                                                <div class="form-group">
