...
use App\Models\modso_g2;
use mysqli;
use PDO;

class conso_g2 extends BaseController
{
	...
	{
		$this->model = new modso_g2();
		$this->base_link = '/so_g2';
	...
	public function tambah_item()
	{
		...
		if ($cek_dump > 0) {
			...
			return redirect()->to('/so_g2/tambah-so');
		} else {
			if ($convert == 'con1') {
