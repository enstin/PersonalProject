...
use App\Models\modso_g3;
use mysqli;
use PDO;

class conso_g3 extends BaseController
{
	...
	{
		$this->model = new modso_g3();
		$this->base_link = '/so_g3';
	...
	public function tambah_item()
	{
		...
		if ($cek_dump > 0) {
			...
			return redirect()->to('/so_g3/tambah-so');
		} else {
			if ($convert == 'con1') {
