...
use App\Models\modbkeluar_g2;
use CodeIgniter\HTTP\Request;
use Config\Database;
use mysqli;
use PDO;

class conbkeluar_g2 extends BaseController
{
	...
	{
		$this->model = new modbkeluar_g2();
		$this->base_link = '/bkeluar_g2';
	...
	public function proseskeluar()
	{
		...
		$id_bkeluar = session()->get('id_bkeluar_g2');
		...
		if (!$sah) {
			...
			return redirect()->to('/bkeluar_g2/draftbkeluar');
			//session salah
		} else {
			$dataup = [
